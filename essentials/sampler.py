...
def get_matrix(filename, converters=None):
	'''
...
def __sample_helper(matrix, testPercent):
	'''
...
def sample(matrix, seed=0, test_percent=.1):
	'''
	...
	'''
	random.seed(seed)
	test,train = sample_helper(matrix, test_percent)
